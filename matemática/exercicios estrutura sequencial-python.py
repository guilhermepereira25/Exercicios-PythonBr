...
#programa que peça um numero e então mostre a mensagem O número informado foi [numero]
...
#programa que pede a area de um circulo, para calcular a area
...
#programa que calcula area do quadrado e mostra o dobro dela
#variaveis
lado = area = dobro = 0
...
#programa que calcula quanto voce ganha por hora e o numero de horas trabalhadas no mês + total do salário
...
#programa que transforma a temperatura de faren em celsius
#variaveis
